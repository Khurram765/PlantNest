...
<!-- Sidebar Start -->
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="./messages.php" class="nav-item nav-link active"><i class="fa fa-envelope me-2"></i>Contact Messages</a>
	...
	<tbody>
        <?php 
            $activityQuery = "SELECT * FROM `contactus`";
		...
		<tr>
			<td><?php echo ++$i ?></td>
			<td><?php echo $fetchActivity['ContactName'] ?></td>
			<td><?php echo $fetchActivity['ContactEmail'] ?></td>
			<td><?php echo $fetchActivity['ContactMessage'] ?></td>
		</tr>
        <?php }}?>
