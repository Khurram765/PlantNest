...
if ($type == 'delete') {
    ...
    $category_id = get_save_value($con, $_GET['category_id']);
    $query = "UPDATE `categories` SET `delete_status`= 1 WHERE `category_id` = $category_id";
...
<?php
$i = 1;
$sel_query = "SELECT * FROM `categories` WHERE delete_status=0";
...
while ($row = mysqli_fetch_assoc($run)) {
    ...
    <tr class="text-center">
        ...
        <td>
            <img src="uploads_img/<?php echo $row[' ']; ?>" width="100px">
        </td>
        <td>
