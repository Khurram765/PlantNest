...
<!-- Sidebar Start -->
        ...
        <div style="overflow-y: scroll;" class="tableContainer content">
            <h1 class="text-center my-4">DONORS DETAILS</h1>
	...
	<tbody>
        <?php 
            $activityQuery = "SELECT users.UserId, donor.DonorName,users.UserEmail,donor.DonorContact,donor.DonorAddress,city.CityName,bloodgroup.GroupName,donor.DonorGender,donor.DonorDOB,donor.DonorWeight FROM `donor` INNER JOIN users ON donor.UserId = users.UserId INNER JOIN city ON donor.CityId = city.CityId INNER JOIN bloodgroup ON donor.GroupId = bloodgroup.GroupId ORDER BY donor.DonorId";
		...
		<tr>
			...
			<td><?php echo $fetchActivity['DonorDOB'] ?></td>
			<td><?php echo $fetchActivity['DonorWeight'] ?></td>
