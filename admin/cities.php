<?php
    ...
    if(isset($_POST['updatecity'])){
        ...
        $updateCity = "UPDATE `city` SET `CityName`='$cityName' WHERE CityId = $cityId";
    ...
    if(isset($_POST['addcity'])){
        ...
        $insertCity = "INSERT INTO `city`(`CityName`) VALUES ('$cityName')";
...
<!-- Sidebar Start -->
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="./cities.php" class="nav-item nav-link active"><i class="fa fa-city me-2"></i>Manage Cities</a>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h2 style="opacity:0.8; font-family:Heebo;" class="modal-title">Add Cities</h1>
      ...
      <div class="modal-body">
        <form role="form" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" onsubmit="return updateValidation(0);">
          <div class="mb-3">
            ...
            <input type="text" class="form-control cityname0" name="cityname" value="" onfocus="focusSetup(document.querySelector(`.cityname0`))">
          </div>
        ...
        <div style="overflow-y: scroll;" class="tableContainer content">
            <div class="d-flex justify-content-between align-items-center mt-5 tableHeader">
                <h3 style="margin:0 !important;">CITIES</h5>
	...
	<tbody>
        <?php 
            $activityQuery = "SELECT * FROM `city`";
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h2 style="opacity:0.8; font-family:Heebo;" class="modal-title">Update Cities</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form role="form" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" onsubmit="return updateValidation(<?php echo $i ?>);">
          <input hidden id="gi" type="" name="cityid" value="<?php echo $fetchActivity['CityId'] ?>">
          <div class="mb-3">
            <label class="form-label">City Name</label>
            <input type="text" class="form-control cityname<?php echo $i ?>" name="cityname" value="<?php echo $fetchActivity['CityName'] ?>" onfocus="focusSetup(document.querySelector(`.cityname<?php echo $i ?>`))">
          </div>
          
          
          <div class="mb-3">
            <button type="submit" class="btn btn-success" name="updatecity">Update</button>
          </div>
        </form>
      </div>
    </div>
...
<a href="#" class="btn btn-lg btn-primary btn-lg-square back-to-top"><i class="bi bi-arrow-up"></i></a>
    ...
    <script>
        function updateValidation(i){
            let cityName = document.querySelector(`.cityname${i}`);
