...
<!-- Sidebar Start -->
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="./finddonors.php" class="nav-item nav-link active"><i class="bi bi-droplet-fill me-2"></i>Find Donors</a>
        ...
        <div style="overflow-y: scroll;" class="tableContainer content">
            <h1 class="text-center my-4">FIND DONORS NEAR YOU</h1>
	...
	<tbody>
        <?php 
            $activityQuery = "SELECT donor.DonorName,users.UserEmail,donor.DonorContact,donor.DonorAddress,bloodgroup.GroupName,city.CityName,donor.DonorGender FROM `donor` INNER JOIN city ON donor.CityId = city.CityId INNER JOIN bloodgroup ON donor.GroupId = bloodgroup.GroupId INNER JOIN users ON donor.UserId = users.UserId WHERE donor.GroupId = $groupId AND donor.CityId = $cityId;";
		...
		<tr>
			...
			<td><?php echo $fetchActivity['DonorAddress'] ?></td>
			<td><?php echo $fetchActivity['DonorContact'] ?></td>
			<td><?php echo $fetchActivity['DonorGender'] ?></td>
