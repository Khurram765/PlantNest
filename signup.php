...
<!-- Mirrored from htmldemo.hasthemes.com/flosun-preview/flosun/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Dec 2020 09:51:12 GMT -->
                    ...
                    <nav class="main-nav mr-5 d-none d-lg-flex">
                        ...
                        <div class="header-right-area main-nav">
                            ...
                            <li class="minicart-wrap">
                                ...
                                <li class="sidemenu-wrap d-flex flex-column register">
                                <a href="signup.php" class="item-register active" id="menu-extra-register">Register</a>
                                </li>
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-custom">
                    <div class="login-register-wrapper">
                        ...
                        <form action="./signup.php" method="post" onsubmit="return signupValidate()">
                            <div class="single-input-item mb-3">
                                <input id="name" name="name" type="text" placeholder="UserName" required pattern="[A-Z a-z]{3,30}" onfocus="removeBorder(document.getElementById('name'))">
                            </div>
                            <div class="single-input-item mb-3">
                                <input id="email" name="email" type="email" placeholder="Email" onfocus="removeBorder(document.getElementById('email'))">
                            </div>
                            <div class="single-input-item mb-3">
                                <input id="password" name="password" type="password" placeholder="Password" onfocus="removeBorder(document.getElementById('password'))">
                            </div>
                            <div class="single-input-item mb-3">
                                <input id="contact" name="contact" type="number" placeholder="Contact Number" onfocus="removeBorder(document.getElementById('contact'))">
                            </div>
                            <div class="single-input-item mb-3">
                                <button type="submit" class="btn flosun-button secondary-btn theme-color rounded-0" name="signup">Register</button>
                            </div>
                        </form>
                    </div>
                </div>
