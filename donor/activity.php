...
<!-- Sidebar Start -->
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="./activity.php" class="nav-item nav-link active"><i class="fa fa-chart-bar me-2"></i>My Activity</a>
                    ...
                    <div class="nav-item ">
                        <a href="./notification.php" class="nav-link" >
                            <i style="position:relative" class="fa fa-bell me-lg-2">
                                ...
                                ?>
                                <input hidden id="userId" type="number" name="" value="<?php echo $userId ?>">
                                <div id="notificationQuantity" style="height:13px;width:14px;background:red;border-radius:30px;position:absolute;left:18%;bottom:42%;color:white;font-size:11px;text-align:center;font-family:Heebo"><?php echo mysqli_num_rows($applyNotiQuantity)?></div>
                                <?php 
                                    }
                                ?>
                            </i>
        ...
        <div style="overflow-y: scroll;" class="tableContainer content">
            <h1 class="text-center my-4">DONATION ACTIVITY</h1>
	...
	<tbody>
        <?php 
            $activityQuery = "SELECT donor.DonorName,bloodgroup.GroupName,donoractivity.Quantity,donoractivity.DonationDate FROM `donoractivity` INNER JOIN donor ON donoractivity.DonorId = donor.DonorId INNER JOIN bloodgroup ON donoractivity.GroupId = bloodgroup.GroupId WHERE donoractivity.DonorId = $donorId";
