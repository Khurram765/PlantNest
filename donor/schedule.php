...
<!-- Sidebar Start -->
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="./schedule.php" class="nav-item nav-link active"><i class="fa fa-calendar me-2"></i>My Schedule</a>
        ...
        <h1 class="text-center my-4">UPCOMING BOOKINGS</h1>
	...
	<tbody>
        <?php 
            $activityQuery = "SELECT donor.DonorName,bloodgroup.GroupName,requesttable.Timings,appointment.AppointmentDate,bloodcenter.CenterName FROM `appointment` INNER JOIN requesttable ON appointment.RequestId = requesttable.RequestId INNER JOIN donor ON requesttable.DonorId = donor.DonorId INNER JOIN bloodgroup ON requesttable.GroupId = bloodgroup.GroupId INNER JOIN bloodcenter ON requesttable.CenterId = bloodcenter.CenterId WHERE requesttable.DonorId = $donorId AND AppointmentStatus = 'coming';";
		...
		<tr>
			...
			<td data-order="1000"><?php echo $fetchActivity['CenterName'] ?></td>
		</tr>
        <?php }}?>
