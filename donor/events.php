...
<!-- Sidebar Start -->
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="./events.php" class="nav-item nav-link active"><i class="fa fa-calendar me-2"></i>Events</a>
	...
	<tbody>
        <?php 
            $activityQuery = "SELECT bloodcenter.CenterName,donationdrive.StartDate,donationdrive.EndDate,donationdrive.DriveTimings,donationdrive.DriveTitle,donationdrive.DriveAddress,donationdrive.DriveDescription FROM `donationdrive` INNER JOIN bloodcenter ON donationdrive.CenterId = bloodcenter.CenterId INNER JOIN city ON bloodcenter.CityId = city.CityId WHERE donationdrive.DriveStatus = 'coming' AND city.CityId = $cityId;";
		...
		<tr>
			...
			<td><?php echo $fetchActivity['DriveDescription'] ?></td>
			<td><?php echo $fetchActivity['CenterName'] ?></td>
			<td data-order="1000"><?php echo $fetchActivity['StartDate'] ?></td>
			<td data-order="1000"><?php echo $fetchActivity['EndDate'] ?></td>
			<td data-order="1000"><?php echo $fetchActivity['DriveAddress'] ?></td>
			<td data-order="1000"><?php echo $fetchActivity['DriveTimings'] ?></td>
		</tr>
        <?php }}?>
