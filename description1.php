...
<?php
    if(isset($_GET['accessory_id'])){
        ...
        $getProduct = mysqli_query($config,"SELECT * FROM accessories WHERE accessory_id = $accessory_id");
    ...
    if(isset($_POST['cart'])){
        ...
        $selectPlant = mysqli_query($config,"SELECT * FROM accessories WHERE accessory_id = $accessory_id");
        $plantAssoc = mysqli_fetch_assoc($selectPlant);
                        ...
                        <div class="single-product-img swiper-container gallery-top popup-gallery">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a class="w-100" href="">
                                        <img class="w-100" src="./admin/uploads_img/<?php echo $fetchProduct['image']  ?>" alt="Product">
                                    </a>
                                </div>
                    ...
                    <div class="product-summery position-relative">
                        ...
                        <div class="quantity-with_btn mb-5">
                            ...
                            <div class="add-to_cart d-flex">
                                ...
                                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                            <input hidden type="number" name="accessory_id" id="" value="<?php echo $fetchProduct['accessory_id']; ?>">
                                            <button type="submit" name="cart" class="btn flosun-button secondary-btn secondary-border rounded-0">Add to Cart</button>
                                </form>
                    ...
                    <div class="product-slider swiper-container anime-element-multi">
                        <div class="swiper-wrapper">
                            ...
                            <?php 
                                ...
                                $getSC = mysqli_query($config,"SELECT * FROM accessories");
                            ...
                            <div class="single-item swiper-slide">
                                ...
                                <div class="single-product position-relative mb-30">
                                    <div class="product-image">
                                        <a class="d-block" href="description.php?plantId=<?php echo $fetchSC['accessory_id'] ?>">
                                            <img src="./admin/uploads_img/<?php echo $fetchSC['image'] ?>" alt="" class="product-image-1 w-100">
                                    ...
                                    <div class="product-content">
                                        <div class="product-title">
                                            <h4 class="title-2"> <a href="description1.php?accessory_id=<?php echo $fetchSC['accessory_id'] ?>"><?php echo $fetchSC['name'] ?></a></h4>
                                        </div>
