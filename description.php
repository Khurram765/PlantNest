...
<?php
    ...
    if(isset($_POST['cart'])){
        ...
        $selectPlant = mysqli_query($config,"SELECT * FROM plants WHERE plant_id = $plantId");
        $plantAssoc = mysqli_fetch_assoc($selectPlant);
        $merge = ["plantId"=>intval($plantAssoc["plant_id"]),"plantImage"=>$plantAssoc["plant_image"],"plantName"=>$plantAssoc["name"],"plantPrice"=>$plantAssoc["price"],"plantDescription"=>$plantAssoc["description"],"stockQuantity"=>$plantAssoc["quantity"],"quantity"=>1,"type"=>"p"];
                    ...
                    <div class="product-summery position-relative">
                        ...
                        <div class="quantity-with_btn mb-5">
                            ...
                            <div class="add-to_cart d-flex">
                                ...
                                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                            <input hidden type="number" name="plantId" id="" value="<?php echo $fetchProduct['plant_id']; ?>">
